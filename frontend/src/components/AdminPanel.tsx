...
export default function AdminPanel() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 font-sans text-gray-800 flex justify-center">
      <div className="w-full max-w-4xl bg-white shadow-xl rounded-2xl overflow-hidden flex flex-col">
        {/* Header */}
        <div className="bg-slate-900 text-white p-6 flex justify-between items-center">
            <div>
                <h1 className="text-2xl font-bold">Amoeba ACP v1</h1>
                <p className="text-slate-400 text-sm">Client Onboarding Control Panel</p>
            </div>
            {clientId && (
